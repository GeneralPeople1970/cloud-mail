...
const premKey = {
	...
	'all-email:query': ['/allEmail/list','/allEmail/latest', '/expiredEmail/list'],
	'user:query': ['/user/list','/user/allAccount', '/emailShare/admin'],
	'all-email:delete': ['/allEmail/delete','/allEmail/batchDelete', '/expiredEmail/delete', '/expiredEmail/batchDelete'],
